...
installer = fso.BuildPath(folder, "Dietory-5.1.0-Setup.exe")
...
If installer = "" Then
  MsgBox "Setup file was not found. Keep INSTALL-SILENT.vbs beside Dietory-5.1.0-Setup.exe.", vbCritical, "Dietory"
  WScript.Quit 1
End If
